...
export const UnderstandingSection: React.FC<UnderstandingSectionProps> = ({ onOpenBooking }) => {
  ...
  return (
    <section id="understanding" className="py-10 sm:py-12 px-4 sm:px-6 lg:px-8 bg-white border-b border-[#EADFC7]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-2 mb-8 sm:mb-10">
          ...
          <p className="text-xs sm:text-sm text-[#6B4B36] max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-0.5">
              ...
              <div className="bg-[#FAF6F0] rounded-xl p-3.5 border border-[#ECE0CE] hover:border-[#D49B35]/60 transition flex items-start gap-3">
                ...
                <div className="space-y-0.5">
                  <h4 className="font-serif-vedic text-xs sm:text-sm font-bold text-[#3B190C] leading-snug">
                    10th House (Karma Bhava)
                  </h4>
                  <p className="text-[11px] text-[#6B4B36] leading-relaxed">
            ...
            <div className="pt-1 flex flex-wrap items-center gap-3">
              <button
                ...
                className="bg-[#8C3E14] hover:bg-[#73310E] text-white px-5 py-2.5 rounded-lg font-bold text-xs sm:text-sm tracking-wide transition shadow-sm flex items-center gap-2 cursor-pointer hover:scale-101 active:scale-99"
              >
          ...
          <div className="lg:col-span-5 flex justify-center items-center">
            <div className="relative w-full max-w-[320px] sm:max-w-[350px] rounded-2xl overflow-hidden shadow-lg border-2 border-[#E3D3BA] bg-[#FAF5EC] group">
              
              {/* Full Image */}
              <img
                src={currentPoster}
                alt="Career Astrology - Discover the Right Path, Timing & Growth with Acharya Hanish Bagga"
                className="w-full max-h-[440px] object-cover object-top rounded-2xl cursor-pointer block transition-transform duration-300 group-hover:scale-[1.02]"
                onClick={onOpenBooking}
                width={750}
                height={1125}
                onError={(e) => {
              ...
              <div className="absolute top-3 right-3 z-20">
                <button
                  ...
                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-[#241710]/85 hover:bg-[#8C3E14] text-white text-[11px] font-semibold border border-white/20 shadow-md backdrop-blur-xs transition cursor-pointer hover:scale-105"
